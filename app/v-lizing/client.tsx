  ...
  const faqData = {
    ...
    registration: [
      ...
      },
      {
        ...
        answer:
          "Да, мы предоставляем лизинг как на новую, так и на подержа��ную спецтехнику из Китая. Условия могут отличаться в зависимости от года выпуска и состояния техники.",
      },
      {
