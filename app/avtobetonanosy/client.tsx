...
export default function ConcretePumpsClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Да, на все новые автобетононасосы предоставляется гарантия производителя сроком 12 месяцев на силовые узлы и агрегаты. Мы также обеспечиваем гарантийное и постгарантийное обслуживание, поставку оригинальных запчастей.",
    },
    {
