...
export const metadata: Metadata = {
  title: "Политика обработки персональных данных | ООО АСТС",
  description:
    "Политика обработки персональных данных ООО АСТС в соответствии с ФЗ-152. Правила сбора, хранения и использования персональных данных на сайте oooasts.ru",
  robots: {
    index: true,
    follow: true,
  },
          ...
          <section className="space-y-6 text-gray-700 leading-relaxed">
            <div>
              ...
              <p className="mb-4">
                ...
                предпринимаемые ООО «АСТС» (далее — Оператор).
              </p>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">2. ОСНОВНЫЕ ПОНЯТИЯ, ИСПОЛЬЗУЕМЫЕ В ПОЛИТИКЕ</h2>
              <p className="mb-2">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">3. ОСНОВНЫЕ ПРАВА И ОБЯЗАННОСТИ ОПЕРАТОРА</h2>
              <p className="mb-4 font-semibold">3.1. Оператор имеет право:</p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>
                  самостоятельно определять состав и перечень мер, необходимых и достаточных для обеспечения вы��олнения
              ...
              <p className="mb-4 font-semibold">3.2. Оператор обязан:</p>
            ...
            <div>
              ...
              <p className="mb-4 font-semibold">4.1. Субъекты персональных данных имеют право:</p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
                <li>
              ...
              <p className="mb-4 font-semibold">4.2. Субъекты персональных данных обязаны:</p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">5. ПРИНЦИПЫ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
              <p className="mb-2">
              ...
              <p className="mb-2">
                5.4. Обработке подлежат только персональные данные, которы�� отвечают целям их обработки.
              </p>
              <p className="mb-2">
            ...
            <div>
              ...
              <p className="mb-4">
                6.1. Правовые основания обработки персональных данных Субъектов персональных данных устанавливаются с
                учетом определенных условий обработки персональных данных. Правовыми основаниями обработки персональных
                данных, на основании которых допускается обработка персональных данных Оператором, являются:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
                <li>
                  согласие Субъекта персональных данных на обработку персональных данных с учетом требований,
                  предусмотренных Законодательством РФ для соответствующей категории персональных данных;
                </li>
                <li>
                  положения нормативных правовых актов, во исполнение которых и в соответствии с которыми Оператор
                  осуществляет обработку персональных данных;
                </li>
                <li>
                  судебные акты, акты другого органа или должностного лица, подлежащие исполнению Оператором в
                  соответствии с положениями законодательства РФ об исполнительном производстве;
                </li>
                <li>
                  права и законные интересы Оператора, Третьих лиц, Партнеров, иных лиц либо достижение общественно
                  значимых целей при условии, что при этом не нарушаются права и свободы Субъекта персональных данных;
                </li>
                <li>
                  обработка персональных данных в статистических или иных исследовательских целях при условии
                  обязательного обезличивания персональных данных.
                </li>
              </ul>

              <p>
                6.2. Оператор обрабатывает обезличенные данные о Пользователе в случае, если это разрешено в настройках
                браузера Пользователя (включено сохранение файлов «cookie» и использование технологии JavaScript).
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">7. УСЛОВИЯ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
              <p className="mb-2">
              ...
              <p className="mb-2">
                ...
                заключения дог��вора по инициативе субъекта персональных данных или договора, по которому субъект
            ...
            <div>
              ...
              <p className="mb-4">
                ...
                действующего законодательства в области защиты персональных данных. На сайте происходит сбор и обработка
                обезличенных данных о посетителях (в т.ч. файлов «cookie») с помощью сервисов интернет-статистики
                (Яндекс.Метрика, Top.Mail.Ru, Пиксель VK Рекламы и других).
              </p>
              ...
              <p className="mb-4">
                8.4. Срок обработки и хранения персональных данных составляет 5 лет. Пользователь может в любой момент
              ...
              <p className="mb-2">
                8.5. Вся информация, которая собирается сторон��ими сервисами, в том числе платежными системами,
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">10. КОНФИДЕНЦИАЛЬНОСТЬ ПЕРСОНАЛЬНЫХ ДАННЫХ</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">11. ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ</h2>
              <p className="mb-2">
              ...
              <p className="mb-2">
                11.2. В данном документе будут отражены любые изменения политики обработки персональных данных
              ...
              <p>
                ...
                <a href="https://oooasts.ru/politika-obrabotki-dannyh" className="text-blue-600 hover:underline">
                  https://oooasts.ru/politika-obrabotki-dannyh
                </a>
                .
              </p>
            </div>
            ...
            <div className="border-t border-gray-200 pt-6 mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Соглашение на обработку персональных данных</h2>
              <p className="mb-4">
                Настоящим в соответствии с Федеральным законом № 152-ФЗ «О персональных данных» от 27.07.2006 года Вы
                подтверждаете свое согласие на обработку компанией ООО «АСТС» персональных данных: сбор, систематизацию,
                накопление, хранение, уточнение (обновление, изменение), использование, передачу исключительно в целях
                продажи программного обеспечения на Ваше имя, блокирование, обезличивание, уничтожение.
              </p>
              <p className="mb-4">
                Компания ООО «АСТС» гарантирует конфиденциальность получаемой информации. Обработка персональных данных
                осуществляется в целях эффективного исполнения заказов, договоров и иных обязательств, принятых
                компанией ООО «АСТС» в качеств�� обязательных к исполнению.
              </p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                направив письменное уведомления на эл. почту{" "}
                <a href="mailto:zhukovigor@yandex.ru" className="text-blue-600 hover:underline">
                  zhukovigor@yandex.ru
                </a>
                .
            ...
            <div className="border-t border-gray-200 pt-6 mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Технологии Cookies</h2>
              <p className="mb-4">
                Cookies – небольшие по размеру текстовые файлы, хранящиеся в браузере Посетителей сайта. На совокупности
                различных веб-проектов Компании (при просмотре веб-сайтов) происходит автоматический сбор (из Cookies)
                обезличенных статистических данных о Посетителе сайта.
              </p>
              <p className="mb-4">
                Пользуясь сайтом, Посетитель соглашается на то, что Компания может использовать статистические данные и
                файлы Cookies для их последующей обработки системами Яндекс.Метрика, Top.Mail.Ru, Пиксель VK Рекламы и
                может передавать третьему лицу для проведения исследований, выполнения работ или оказания услуг по
                поручению Компании.
              </p>
              <p className="mb-4">
                ...
                привести к недоступности отдельных компонентов интернет-сайта (
                <a href="https://oooasts.ru/" className="text-blue-600 hover:underline">
                  https://oooasts.ru/
                </a>
                ).
