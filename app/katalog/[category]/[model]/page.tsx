...
export default function ClientModelPage({ category, model, params }: ClientModelPageProps) {
  ...
  // Функция для рендеринга значений спецификаций
  ...
  // Определяем тип техники по категории или названию
  const isConcretePump = model.name?.toLowerCase().includes('бетононасос') || 
                        category?.name?.toLowerCase().includes('бетононасос')
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            {/* Key Specs - разные для экскаваторов и бетононасосов */}
