...
import { Menu, X, ChevronDown, Phone, MapPin, Clock, Heart, ShoppingCart, Search } from "lucide-react"
...
export default function SiteNavigation() {
  ...
  return (
    <>
                ...
                if (item.submenu) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`absolute top-full left-0 w-56 bg-white rounded-lg shadow-xl overflow-hidden transition-all duration-300 z-50 ${
                          isOpen
      ...
      {mounted && isMenuOpen && (
        <div className="fixed inset-0 bg-black/90 z-50 md:hidden overflow-y-auto">
