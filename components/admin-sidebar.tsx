...
import { LayoutDashboard, FileText, Package, Menu, X, ChevronDown, ChevronRight, Users, Mail, Bell, Send } from 'lucide-react'
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-2">
            ...
            {/* Commercial Offers link */}
            <Link
              href="/admin/commercial-offers"
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive("/admin/commercial-offers") ? "bg-blue-50 text-blue-600" : "text-gray-700 hover:bg-gray-100"
              }`}
              onClick={() => setIsOpen(false)}
            >
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                isActive("/admin/newsletter") ? "bg-blue-50 text-blue-600" : "text-gray-700 hover:bg-gray-100"
              }`}
              onClick={() => setIsOpen(false)}
            >
